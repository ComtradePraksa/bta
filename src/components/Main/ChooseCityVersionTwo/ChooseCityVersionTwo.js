        ...
        return (
            <div className={[classes.chooseCity, classes.flex].join(' ')}>
                ...
                {!this.state.dropdownVisible &&
                    ...
                    <h2 className={[classes.cityLink, classes.pointer].join(' ')} onClick={this.toggleDropdown}>city               <FontAwesomeIcon icon="chevron-down" style={{fontSize: "1rem", padding: "0 8px", color: "rgba(1, 1, 34, 0.979)"}}/></h2>}
                {this.state.dropdownVisible &&
